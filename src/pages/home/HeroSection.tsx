  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center gradient-bg overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute top-40 right-20 w-16 h-16 bg-brand-red/20 rounded-full"
          animate={{
            y: [0, -20, 0],
            scale: [1, 1.3, 1],
            opacity: [0.4, 0.8, 0.4]
        ...
        />
        <motion.div
          className="absolute bottom-40 left-20 w-24 h-24 bg-red-600/20 rounded-full"
          animate={{
            x: [0, 30, 0],
            scale: [1, 0.8, 1],
            opacity: [0.2, 0.5, 0.2]
        ...
        />
        <motion.div
          className="absolute bottom-20 right-40 w-12 h-12 bg-red-700/20 rounded-full"
          animate={{
            rotate: [0, 360],
            scale: [1, 1.5, 1],
            opacity: [0.3, 0.7, 0.3]
      ...
      >
           ...
           <motion.div className="space-y-8" variants={itemVariants}>
             <motion.div className="space-y-6" variants={itemVariants}>
               ...
               <motion.p
                 className="text-lg md:text-xl text-brand-gray-100 leading-relaxed"
                 variants={itemVariants}
               >
                 {isArabic 
             ...
             >
                 ...
                 >
                   {isArabic ? 'ابدأ تجربتك المجانية' : 'Start Your Free Trial'}
                              ...
                              <motion.button
                  className="btn-creative group relative"
             ...
             >
               {stats.map((stat, index) => (
                 ...
                 >
                   ...
                   <div className="text-sm text-brand-gray-200 mt-1">
                     {stat.label}
                   </div>
                 </motion.div>
               ))}
          ...
          >
                      <motion.div
            className="logo-3d-container w-96 h-96 flex items-center justify-center cursor-pointer"
            style={{ 
              perspective: "1000px",
              border: "none",
            ...
            >
                ...
                <div className="relative">
                  <motion.img
                    src="/favicon.png"
                    alt="Ignite Logo"
                    className="w-80 h-80 object-contain filter drop-shadow-lg relative z-10"
                    style={{
                  ...
                  <motion.div
                    className="absolute inset-0 w-80 h-80 overflow-hidden"
                    style={{
